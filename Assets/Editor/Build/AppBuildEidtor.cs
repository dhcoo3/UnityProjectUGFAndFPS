...
namespace Editor.Build
{
    ...
    public class AppBuildEidtor : EditorWindow
    {
        ...
        [MenuItem("Game Framework/Builder", false, 50)]
        ...
        private void OnEnable()
        {
            ...
            {
                m_Controller.OutputDirectory = BuildConst.AssetBundleOutputPath;
            }
            ...
            scrollPosition = EditorGUILayout.BeginScrollView(scrollPosition);
            {
                    ...
                    EditorGUILayout.BeginVertical();
                    {
                        ...
                        EditorGUILayout.BeginHorizontal("box");
                        {
                            ...
                            EditorGUILayout.BeginVertical();
                            {
                                ...
                                DrawPlatform(Platform.MiniGame, "MiniGame");
                            }
                            EditorGUILayout.EndVertical();
                        }
                        EditorGUILayout.EndHorizontal();
                ...
                EditorGUILayout.BeginHorizontal("box");
                {
                    EditorGUI.BeginDisabledGroup(m_Controller.Platforms == Platform.Undefined 
                                                 ...
                                                 || AppSettings.Instance.ResourceMode == ResourceMode.Unspecified);
                    {
        ...
        {
            string aotSaveDir = AssetPathUtil.GetCombinePath("Resources", LaunchConst.AotdllDir);
        ...
        {
            var linkDir = Path.GetDirectoryName(BuildConst.HotfixAssembly);
            var linkFile = AssetPathUtil.GetCombinePath(linkDir, "link.xml");
            if (v)
            {
        ...
        private void OnProcessResourceComplete(Platform platform)
        {
            ...
            {
                EditorUtility.RevealInFinder(AssetPathUtil.GetCombinePath(GetResourceOupoutPathByMode(AppSettings.Instance.ResourceMode), platform.ToString()));
            }
        }
        ...
        {
            string defaultFolder = AssetPathUtil.GetCombinePath(Directory.GetParent(Application.dataPath).FullName, AppBuildSettings.Instance.AppBuildDir, target.ToString());
            ...
            if (!string.IsNullOrEmpty(extension))
            {
                ...
                buildPath = AssetPathUtil.GetCombinePath(defaultFolder, appFileName);
            }
            return buildPath;
        }
        #region Jenkins打包
        ...
        public void JenkinsBuildResource(JenkinsBuildResourceConfig configJson)
        {
            ...
            Debug.Log($"{JsonUtil.ToJson(configJson)}");
            Debug.Log($"#########################################");
        ...
        public void JenkinsBuildApp(JenkinsBuildAppConfig configJson)
        {
            ...
            Debug.Log($"{JsonUtil.ToJson(AppBuildSettings.Instance)}");
            Debug.Log($"#########################################");
