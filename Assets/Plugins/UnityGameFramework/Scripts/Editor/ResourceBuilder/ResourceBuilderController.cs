    ...
    public sealed partial class ResourceBuilderController
    {
        ...
        public bool BuildResources()
        {
            ...
            try
            {
                ...
                if (!watchResult || isSuccess)
                {
                    isSuccess = BuildResources(Platform.MiniGame, assetBundleBuildDatas, buildAssetBundleOptions, assetBundleResourceDatas, binaryResourceDatas);
                }
        ...
        private static BuildTarget GetBuildTarget(Platform platform)
        {
            switch (platform)
            {
                ...
                case Platform.MiniGame:
                    return BuildTarget.MiniGame;
                default:
