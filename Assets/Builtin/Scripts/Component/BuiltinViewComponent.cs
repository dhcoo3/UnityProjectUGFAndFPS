...
namespace Builtin.Scripts.Component
{
    public class BuiltinViewComponent : GameFrameworkComponent
    {
        ...
        [Space(20)] [Header("Tips Dialog:")] [SerializeField]
        GameObject tipsDialog = null;
        ...
        public void SetLoadingProgress(float progress)
        {
            ...
            loadSliderText.text = ZString.Format("{0:N0}%", loadSlider.value * 100);
        }
        ...
        public void ShowDialog(string title, string content, string yes_btn_title = "YES", string no_btn_title = "NO",
            UnityEngine.Events.UnityAction yes_cb = null, UnityEngine.Events.UnityAction no_cb = null)
        {
            ...
            if (no_cb != null)
                tipsNegativeBtn.onClick.AddListener(() =>
                {
                    no_cb.Invoke();
                    HideDialog();
                });
            if (yes_cb != null)
                tipsPositiveBtn.onClick.AddListener(() =>
                {
                    yes_cb.Invoke();
                    HideDialog();
                });
