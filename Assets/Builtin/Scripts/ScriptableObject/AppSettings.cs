...
namespace UGF.EditorTools
{
    ...
    public class AppSettinsInspector : Editor
    {
        ...
        private static void SetDesignResolution(Vector2Int designResolution)
        {
            ...
            var launchSceneName = AssetPathUtil.GetScenePath("Launch");
            ...
            var gfExtension = AssetPathUtil.GetEntity("Core/GameExtension");
...
[CreateAssetMenu(fileName = "AppSettings", menuName = "Tool/AppSettings [App内置配置参数]")]
