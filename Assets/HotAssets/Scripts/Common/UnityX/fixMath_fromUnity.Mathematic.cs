...
public static partial class fixMath
{
    ...
    */
    ...
    // public static fix FLT_MIN_NORMAL => fix(1.175494351e-38F); // TODO fbessette
    public static fix FLT_MIN_NORMAL => global::fix.FromRaw(0L); // 运行时上面的float转换成long就是0

    /// <summary>The mathematical constant e also known as Euler's number. Approximately 2.72.</summary>
    public static fix E => global::fix.FromRaw(11674931554L);

    /// <summary>The base 2 logarithm of e. Approximately 1.44.</summary>
    public static fix LOG2E => global::fix.FromRaw(6196328018L);

    /// <summary>The base 10 logarithm of e. Approximately 0.43.</summary>
    public static fix LOG10E => global::fix.FromRaw(1865280596L);

    /// <summary>The natural logarithm of 2. Approximately 0.69.</summary>
    public static fix LN2 => global::fix.FromRaw(2977044471L);

    /// <summary>The natural logarithm of 10. Approximately 2.30.</summary>
    public static fix LN10 => global::fix.FromRaw(9889527670L);

    /// <summary>The mathematical constant pi. Approximately 3.14.</summary>
    public static fix PI => global::fix.FromRaw(13493037704L);

    /// <summary>The square root 2. Approximately 1.41.</summary>
    public static fix SQRT2 => global::fix.FromRaw(6074000999L);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix saturate(fix x) { return clamp(x, global::fix.Zero, global::fix.One); }

    /// <summary>Returns the result of a componentwise clamping of the fix2 vector x into the interval [0, 1].</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix2 saturate(fix2 x) { return clamp(x, new fix2(global::fix.Zero), new fix2(global::fix.One)); }

    /// <summary>Returns the result of a componentwise clamping of the fix3 vector x into the interval [0, 1].</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix3 saturate(fix3 x) { return clamp(x, new fix3(global::fix.Zero), new fix3(global::fix.One)); }

    /// <summary>Returns the result of a componentwise clamping of the fix4 vector x into the interval [0, 1].</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix4 saturate(fix4 x) { return clamp(x, new fix4(global::fix.Zero), new fix4(global::fix.One)); }
    ...
    public static fix rcp(fix x) { return global::fix.One / x; }

    /// <summary>Returns the componentwise reciprocal a fix2 vector.</summary>
    public static fix2 rcp(fix2 x) { return global::fix.One / x; }

    /// <summary>Returns the componentwise reciprocal a fix3 vector.</summary>
    public static fix3 rcp(fix3 x) { return global::fix.One / x; }

    /// <summary>Returns the componentwise reciprocal a fix4 vector.</summary>
    public static fix4 rcp(fix4 x) { return global::fix.One / x; }
    ...
    public static fix exp2(fix x) { return global::fix.Pow(global::fix.Two, x); }
    ...
    public static fix smoothstep(fix a, fix b, fix x)
    {
        ...
        return t * t * (global::fix.Three - (global::fix.Two * t));
    }
    ...
    {
        var t = saturate((x - a) / (b - a));
        return t * t * (fix2(global::fix.Three) - (global::fix.Two * t));
    }
    ...
    {
        var t = saturate((x - a) / (b - a));
        return t * t * (fix3(global::fix.Three) - (global::fix.Two * t));
    }
    ...
    {
        var t = saturate((x - a) / (b - a));
        return t * t * (fix4(global::fix.Three) - (global::fix.Two * t));
    }

    /// <summary>Returns true if any component of the input fix2 vector is non-zero, false otherwise.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool any(fix2 x) { return x.x != global::fix.Zero || x.y != global::fix.Zero; }

    /// <summary>Returns true if any component of the input fix3 vector is non-zero, false otherwise.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool any(fix3 x) { return x.x != global::fix.Zero || x.y != global::fix.Zero || x.z != global::fix.Zero; }

    /// <summary>Returns true if any component of the input fix4 vector is non-zero, false otherwise.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool any(fix4 x) { return x.x != global::fix.Zero || x.y != global::fix.Zero || x.z != global::fix.Zero || x.w != global::fix.Zero; }

    /// <summary>Returns true if all components of the input fix2 vector are non-zero, false otherwise.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool all(fix2 x) { return x.x != global::fix.Zero && x.y != global::fix.Zero; }

    /// <summary>Returns true if all components of the input fix3 vector are non-zero, false otherwise.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool all(fix3 x) { return x.x != global::fix.Zero && x.y != global::fix.Zero && x.z != global::fix.Zero; }

    /// <summary>Returns true if all components of the input fix4 vector are non-zero, false otherwise.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool all(fix4 x) { return x.x != global::fix.Zero && x.y != global::fix.Zero && x.z != global::fix.Zero && x.w != global::fix.Zero; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix step(fix y, fix x) { return select(global::fix.Zero, global::fix.One, x >= y); }

    /// <summary>Given an incident vector i and a normal vector n, returns the reflection vector r = i - 2.0f * dot(i, n) * n.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix2 reflect(fix2 i, fix2 n) { return i - global::fix.Two * n * dot(i, n); }

    /// <summary>Given an incident vector i and a normal vector n, returns the reflection vector r = i - 2.0f * dot(i, n) * n.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix3 reflect(fix3 i, fix3 n) { return i - global::fix.Two * n * dot(i, n); }

    /// <summary>Given an incident vector i and a normal vector n, returns the reflection vector r = i - 2.0f * dot(i, n) * n.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix4 reflect(fix4 i, fix4 n) { return i - global::fix.Two * n * dot(i, n); }
    ...
    {
        fix ni = dot(n, i);
        fix k = global::fix.One - eta * eta * (global::fix.One - ni * ni);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix2 faceforward(fix2 n, fix2 i, fix2 ng) { return select(n, -n, dot(ng, i) >= global::fix.Zero); }

    /// <summary>Conditionally flips a vector n to face in the direction of i. Returns n if dot(i, ng) < 0, -n otherwise.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix3 faceforward(fix3 n, fix3 i, fix3 ng) { return select(n, -n, dot(ng, i) >= global::fix.Zero); }

    /// <summary>Conditionally flips a vector n to face in the direction of i. Returns n if dot(i, ng) < 0, -n otherwise.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix4 faceforward(fix4 n, fix4 i, fix4 ng) { return select(n, -n, dot(ng, i) >= global::fix.Zero); }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static fix3 up() { return new fix3(global::fix.Zero, global::fix.One, global::fix.Zero); }  // for compatibility
