...
public struct fix : IEquatable<fix>, IComparable<fix>, IFormattable
{
    ...
    public static fix Epsilon => new fix(rawValue: 1L);
    ...
    public static fix Two => new fix(TWO);
    public static fix Three => new fix(THREE);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator fix(long value)
    {
        return new fix(value * ONE);
    }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator long(fix value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator float(fix value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator double(fix value)
    {
