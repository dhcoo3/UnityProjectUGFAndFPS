...
{
    public static fix2 NextFix2(this FixRandom random)                                 => new fix2(random.NextFix(), random.NextFix());
    public static fix2 NextFix2(this FixRandom random, fix2 max)                 => new fix2(random.NextFix(max.x), random.NextFix(max.y));
    public static fix2 NextFix2(this FixRandom random, fix2 min, fix2 max) => new fix2(random.NextFix(min.x, max.x), random.NextFix(min.y, max.y));
    public static fix3 NextFix3(this FixRandom random)                                 => new fix3(random.NextFix(), random.NextFix(), random.NextFix());
    public static fix3 NextFix3(this FixRandom random, fix3 max)                 => new fix3(random.NextFix(max.x), random.NextFix(max.y), random.NextFix(max.z));
    public static fix3 NextFix3(this FixRandom random, fix3 min, fix3 max) => new fix3(random.NextFix(min.x, max.x), random.NextFix(min.y, max.y), random.NextFix(min.z, max.z));
    public static fix4 NextFix4(this FixRandom random)                                 => new fix4(random.NextFix(), random.NextFix(), random.NextFix(), random.NextFix());
    public static fix4 NextFix4(this FixRandom random, fix4 max)                 => new fix4(random.NextFix(max.x), random.NextFix(max.y), random.NextFix(max.z), random.NextFix(max.w));
    public static fix4 NextFix4(this FixRandom random, fix4 min, fix4 max) => new fix4(random.NextFix(min.x, max.x), random.NextFix(min.y, max.y), random.NextFix(min.z, max.z), random.NextFix(min.w, max.w));
    ...
    /// </summary>
    public static void Shuffle<T>(this FixRandom random, List<T> collection)
    {
        T temp;
    ...
    /// Shuffle your list with simulation random
    /// </summary>
    public static void Shuffle<T>(this FixRandom random, T[] collection)
    {
        T temp;
    ...
    /// Shuffle your list with simulation random
    /// </summary>
    // public static void Shuffle<T>(this FixRandom random, NativeList<T> collection) where T : unmanaged
    // {
