...
public struct fix4 : IEquatable<fix4>
{
    ...
    public static void Add(fix4 a,  fix4 b, out fix4 sum)
    {
        sum.x = a.x + b.x;
        sum.y = a.y + b.y;
        sum.z = a.z + b.z;
    ...
    public static void Subtract(fix4 a,  fix4 b, out fix4 difference)
    {
    ...
    public static void Multiply(fix4 v, fix scale, out fix4 result)
    {
        result.x = v.x * scale;
        result.y = v.y * scale;
        result.z = v.z * scale;
    ...
    public static void Multiply(fix4 a,  fix4 b, out fix4 result)
    {
        result.x = a.x * b.x;
        result.y = a.y * b.y;
        result.z = a.z * b.z;
    ...
    public static void Divide(fix4 v, fix divisor, out fix4 result)
    {
    ...
    public static fix4 operator *(fix4 v,  fix f)
    {
        fix4 toReturn;
        toReturn.x = v.x * f;
        toReturn.y = v.y * f;
    ...
    /// <param name="f">Amount to scale.</param>
    /// <returns>Scaled vector.</returns>
    public static fix4 operator *(fix f,  fix4 v)
    {
        fix4 toReturn;
        toReturn.x = v.x * f;
        toReturn.y = v.y * f;
    ...
    public static fix4 operator *(fix4 a,  fix4 b)
    {
        fix4 result;
    ...
    /// Divides a vector.
    /// </summary>
    public static fix4 operator /(fix4 v1, fix4 v2)
    {
        return new fix4(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z, v1.w / v2.w);
    }

    public static fix4 operator /(fix v, fix4 v2)
    {
    ...
    public static fix4 operator -(fix4 v)
    {
    ...
    public static void DistanceSquared(fix4 a,  fix4 b, out fix distanceSquared)
    {
        fix x = a.x - b.x;
        fix y = a.y - b.y;
        fix z = a.z - b.z;
    ...
    public static void Distance(fix4 a,  fix4 b, out fix distance)
    {
        fix x = a.x - b.x;
        fix y = a.y - b.y;
        fix z = a.z - b.z;
    ...
    public static void Normalize(fix4 v, out fix4 result)
    {
    ...
    public static void Negate(fix4 v, out fix4 negated)
    {
        negated.x = -v.x;
        negated.y = -v.y;
        negated.z = -v.z;
    ...
    public static void Abs(fix4 v, out fix4 result)
    {
        if (v.x < F64.C0)
            result.x = -v.x;
        else
    ...
    public static void Min(fix4 a,  fix4 b, out fix4 min)
    {
    ...
    public static void Max(fix4 a,  fix4 b, out fix4 max)
    {
    ...
    public static fix4 Lerp(fix4 start,  fix4 end,  fix interpolationAmount)
    {
        fix4 toReturn;
    ...
    public static void Lerp(fix4 start,  fix4 end,  fix interpolationAmount, out fix4 result)
    {
